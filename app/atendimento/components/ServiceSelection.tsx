        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 pb-4">
          {SERVICES.map((service) => (
            ...
            >
              ...
              <div className={`w-12 h-12 md:w-14 md:h-14 rounded-xl flex items-center justify-center mr-4 bg-${service.colorClass}-50 text-${service.colorClass}-600 group-hover:scale-110 transition-transform`}>
