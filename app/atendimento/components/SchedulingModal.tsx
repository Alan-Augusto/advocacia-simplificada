            ...
            <div>
              {loadingSlots ? (
                ...
                <div className="text-center py-12">
                  ...
                  <button
                    onClick={onClose}
                    className="mt-5 inline-flex items-center justify-center rounded-xl border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-all"
                  >
                    Voltar ao chat
                  </button>
                </div>
